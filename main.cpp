...
int main()
{
    ...
    LoadModel();
    printf("2");
    hstring imagePath = L"C:\\Windows-Machine-Learning-master\\SharedContent\\media\\kitten_224.png";
...
{
    // load the model
    hstring modelPath = L"C:\\Windows-Machine-Learning-master\\SharedContent\\models\\SqueezeNet.onnx";
...
void LoadLabels()
{
    ...
    string labelsFilePath = "C:\\Windows-Machine-Learning-master\\Samples\\SqueezeNetObjectDetection\\Desktop\\cpp\\Labels.txt";
